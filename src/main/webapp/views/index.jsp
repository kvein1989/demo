...
<title>首页</title>
<link rel="stylesheet" type="text/css" href="${path }/resources/jquery/ligerUI/skins/Aqua/css/ligerui-all.css">
<script type="text/javascript" src="${path }/resources/jquery/jquery-1.5.2.min.js"></script>
<script type="text/javascript" src="${path }/resources/jquery/ligerUI/js/ligerui.all.js"></script>
